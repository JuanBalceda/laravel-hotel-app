...
<div class="row">
    <div class="medium-12 large-12 columns">
        ...
        <form action="{{ $modify == 1 ? route('show_client', ['client_id' => $client_id]) : route('create_client') }}" method="post">
            ...
            <div class="medium-8  columns">
                <label>Address</label>
                <input name="address" type="text" value="{{ old('address') ? old('last_name') : $last_name }}">
